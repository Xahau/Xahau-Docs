...
| `asfDisallowIncomingCheck`        | 13            | `lsfDisallowIncomingCheck`        | Block incoming Checks.                                                                                                                                                                                                                                                                                                                |
| `asfDisallowIncomingNFTokenOffer` | 12            | `lsfDisallowIncomingNFTokenOffer` | Block incoming NFTokenOffers.                                                                                                                                                                                                                                                                                                         |
| `asfDisallowIncomingPayChan`      | 14            | `lsfDisallowIncomingPayChan`      | Block incoming Payment Channels.                                                                                                                                                                                                                                                                                                      |
| `asfDisallowIncomingTrustline`    | 15            | `lsfDisallowIncomingTrustline`    | Block incoming trust lines.                                                                                                                                                                                                                                                                                                           |
| `asfDisallowIncomingRemit`        | 16            | `lsfDisallowIncomingRemit`        | Block incoming Remit txn.                                                                                                                                                                                                                                                                                                             |
