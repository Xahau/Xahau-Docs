...
| `HookNamespaces`       | Array     | Vector256           | No        | A unique value to prevent state conflicts between multiple Hooks installed on the same XRPL account.                                                                                                                                                                                   |
| `RewardLgrFirst`       | Number    | UInt32              | No        |                                                                                                                                                                                                                                                                                        |
| `RewardLgrLast`        | Number    | UInt32              | No        |                                                                                                                                                                                                                                                                                        |
| `RewardTime`           | Number    | UInt32              | No        |                                                                                                                                                                                                                                                                                        |
| `RewardAccumulator`    | String    | UInt64              | No        |                                                                                                                                                                                                                                                                                        |
...
| `ImportSequence`       | Number    | UInt32              | No        | The current sequence number from the importing account on the XRPL Ledger.                                                                                                                                                                                                             |
